...
2.  {{% resource_link "1027d346-72ba-4c04-a82b-5e16b10f40e6" "![Buy at MIT Press](/images/mp_logo.gif)" %}} Roads, C. {{% resource_link "1027d346-72ba-4c04-a82b-5e16b10f40e6" "_The Computer Music Tutorial_" %}}. Cambridge, MA: MIT Press, 1996. ISBN: 9780262680820.
...
Digital media assignments, when required, must be submitted (if smaller than 10 MB) via email attachment or (if larger than 10 MB) via a digital delivery service like Pando (free {{% resource_link "72147365-7a18-4b84-ae16-1eecca5b85e3" "Basic Version" %}}) or YouSendIt (free Lite {{% resource_link "bfe32641-3dec-458b-988b-2fa0a1b8ac38" "account" %}}). Upon receipt by the instructor students will receive an email confirmation within twelve hours. If a student does not receive email confirmation, it is the student's responsibility to contact the instructor and/or re-send the assignment.
...
Suspected cases of academic misconduct will be handled according to section 10.2 of {{% resource_link "7e7f5770-5707-4392-ab4d-652fc2ec5ddc" "MIT Policies and Procedures" %}}.
